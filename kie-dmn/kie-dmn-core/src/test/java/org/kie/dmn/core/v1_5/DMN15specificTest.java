 ...
 */
public class DMN15specificTest extends BaseVariantTest {

    public static final Logger LOG = LoggerFactory.getLogger(DMN15specificTest.class);
    ...
    public void dMNv15Put(final VariantTestConf conf) {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void dMNv15PutAll(final VariantTestConf conf) {
        testConfig = conf;
        final DMNRuntime runtime = createRuntime("exampleContextMerge.dmn", this.getClass());
        final DMNModel dmnModel = runtime.getModel("https://kubesmarts.org/dmn/_864E9A62-12E5-41DC-A7A6-7F028822A067", "examplePutAll");
        assertThat(dmnModel).isNotNull();
        assertThat(dmnModel.hasErrors()).describedAs(formatMessages(dmnModel.getMessages())).isFalse();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void simple(final VariantTestConf conf) {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void dMNv15Ch11(final VariantTestConf conf) {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void dMNv15Ch11Example2(final VariantTestConf conf) {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void sample_for(final VariantTestConf conf) {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void sample_quantified(final VariantTestConf conf) {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void sample_conditional(final VariantTestConf conf) {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void sample_filter(final VariantTestConf conf) {
        testConfig = conf;
