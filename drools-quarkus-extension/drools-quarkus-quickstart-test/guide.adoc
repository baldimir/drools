...
However, you can go explore the original example at the following link: https://github.com/kubesmarts/drools/tree/main/drools-quarkus-extension/drools-quarkus-quickstart-test
