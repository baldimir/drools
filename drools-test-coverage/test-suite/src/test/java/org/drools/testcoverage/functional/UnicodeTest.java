...
public class UnicodeTest {
    ...
    public void testConsequence() {
        // DROOLS-3402
        final KieServices kieServices = KieServices.Factory.get();
        final Resource resource = kieServices.getResources().newClassPathResource(
                "org/drools/testcoverage/functional/unicode-consequence.drl",
                StandardCharsets.UTF_8.name());
        final KieBase kieBase = KieBaseUtil.getKieBaseFromResources(kieBaseTestConfiguration, resource);
        ...
        try {
            ...
            assertThat(p.getName()).isEqualTo("Rückfrage");
